...
for (feat.name in names(mtcars)[3:ncol(mtcars)]) {
    ...
    gg[[ii]] <- ggplot(mtcars, aes_string(x=feat.name, 
        ...
        geom_smooth(aes_string(x=feat.name, y="mpg"), method="lm", 
                    col="black", se=FALSE)
}
...
## Model reduction
Used the ANOVA model search technique to identify variables of interest to our model. We begin with effect of the transmission, since we are specifically interested in it's effect. 
